...
================
*/
static void SUB_DislodgeRestingEntities(void)
{
	gedict_t *e;
...
static void make_breakable_templates_debris(void)
{
...
static void make_breakable_debris(void)
{
	float i;
...
static void func_breakable_killed(void)
{
...
static void break_template_setup(void)
{
	if (!strnull(self->brk_template1))
	{
